...
<script src="{{ url('admin/app-assets/vendors/js/extensions/dragula.min.js') }}"></script>
...
<script src="{{ url('admin/app-assets/vendors/js/tables/datatable/buttons.bootstrap4.min.js') }}"></script>
...
<script src="{{ url('admin/app-assets/vendors/js/extensions/sweetalert2.all.min.js') }}"></script>
<script src="{{ url('admin/app-assets/vendors/js/extensions/polyfill.min.js') }}"></script>
<!-- END: Page Vendor JS-->

...
<head>
    ...
    <title>Login Jurnal Harian</title>
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-md-6 col-12 px-0">
                                <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                    <div class="card-body">
                                        <img src="{{ url('logo-siakad.png') }}" width="50px" style="margin-left: 42%; margin-right: 50%;">
...
{{--                                            </g>--}}
{{--                                        </svg>--}}
                                        <h4 class="text-center mb-2 text-primary">Jurnal Harian Universitas Mulia</h4>
